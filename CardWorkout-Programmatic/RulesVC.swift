...
class RulesVC: UIViewController {
    ...
    //recall in storyboard: we created a segue where if you click Rules button, it popped up a Rules screen. We did not even make a RulesVC for it. Segue is only possible in storyboard
    ...
    func configureTitleLabel(){
        ...
        NSLayoutConstraint.activate([
            //remember labels do not need height
